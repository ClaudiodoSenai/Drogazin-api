...
class FornecedoresRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'inscriçao municipal' => 'required|max:11|min:8|unique:fornecedores,inscriçao municipal',
    ...
    public function messages()
    {
        return [
            ...
            'inscriçao municipal.required' => 'inscriçao municipal obrigatório',
            'inscriçao municipal.max' => 'inscriçao municipal deve conter no máximo 11 caracteres',
            'inscriçao municipal.min' => 'inscriçao municipal deve conter no mínimo 11 caracteres',
            'inscriçao municipal.unique' => 'inscriçao municipal Já cadastrado no sistema',
            'pais.required' => 'CPF obrigatório',
            'pais.max' => 'CPF deve conter no máximo 11 caracteres',
